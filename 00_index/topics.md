...
- **docs** (3): most recent → [Debugging and profiling with set -x and trace traps](../bash/docs/debug-and-profile-with-set-x-and-trace-traps.md), [Strict mode and trap patterns](../bash/docs/strict-mode-trap-patterns.md), [Robust Bash scripting](../bash/docs/2026-07-23-robust-bash-scripts.md)
...
- **templates** (9): [Bash + Docker scaffold](../bash/templates/bash-docker-scaffold/README.md)
...
- **notes** (1): [Installing Jenkins and opening the web UI](../jenkins/notes/2026-08-11-install-jenkins-and-open-web-ui.md)
...
## Concepts (docs/concepts/)  ·  46 files
