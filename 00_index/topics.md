...
- **notes** (3): most recent → [Explore kubectl CLI](../k8s/notes/2026-08-03-explore-kubectl-cli.md), [Install Minikube and run kubectl version](../k8s/notes/2026-08-02-explore-kubectl-cli.md)
...
## Concepts (docs/concepts/)  ·  28 files

Foundational primers on the ideas the tools build on — one primer per concept, plus runnable scripts, snippets, and a notebook.
