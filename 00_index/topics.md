...
- **manifests** (2): [Multi-service application](../k8s/manifests/multi-service-application.yaml), [Minimal deployment and service](../k8s/manifests/2026-08-04-minimal-deployment-and-service.yaml)
...
- **configs** (2): [First scrape target](../prom/configs/2026-08-07-first-scrape-target.yaml), [Prometheus scrape config](../prom/configs/2026-08-22-prometheus-scrape-config.yaml)
...
- **snippets** (5): most recent → [Docker Compose validator](../python/snippets/docker-compose-validator.py), [Validate Docker Compose](../python/snippets/validate-docker-compose.py), [Config file reader](../python/snippets/2026-08-22-config-file-reader.py), [First script — variables and types](../python/snippets/2026-07-22-first-script-variables-types.py)
- **configs** (1): [pyproject.toml config](../python/configs/2026-08-24-pyproject-toml-config.toml)
